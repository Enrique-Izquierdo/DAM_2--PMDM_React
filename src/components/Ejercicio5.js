    ...
    render() {
      return (
        <div className="pagina">
              ...
              <p id="uno" onMouseOver={this.handleOver} onMouseOut={this.handleOut}>{this.state.parrafoUno}</p>
              <p id="dos"onMouseOver={this.handleOver} onMouseOut={this.handleOut}>{this.state.parrafoDos}</p>
              <p id="tres"onMouseOver={this.handleOver} onMouseOut={this.handleOut}>{this.state.parrafoTres}</p>
              <p id="cuatro"onMouseOver={this.handleOver} onMouseOut={this.handleOut}>{this.state.parrafoCuatro}</p>
              <p id="cinco"onMouseOver={this.handleOver} onMouseOut={this.handleOut}>{this.state.parrafoCinco}</p>
          </div>
        )
    }
  }
