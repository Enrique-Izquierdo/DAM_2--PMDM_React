    ...
    render() {
        return (
            <div className='stDiv'>
                ...
                <p>Ejercicio 5 – En el componente Contenido, introduce cinco párrafos. Implementa la 
                    lógica necesaria para que cuando el usuario pase el cursor sobre cada párrafo, el color 
                    de fondo de ese párrafo cambie. Cuando el cursor deje ese párrafo, el contenido pasará 
                    al color original. Utiliza cinco colores distintos de manera que cada párrafo cambie a un 
                    color diferentes del resto de párrafos. </p>
                <h2>Ejercicio 5</h2>
                <p id="1" onMouseOver={this.handleOver} onMouseOut={this.handleOut}>{this.state.texto1}</p>
                <p id="2" onMouseOver={this.handleOver} onMouseOut={this.handleOut}>{this.state.texto2}</p>
                <p id="3" onMouseOver={this.handleOver} onMouseOut={this.handleOut}>{this.state.texto3}</p>
                <p id="4" onMouseOver={this.handleOver} onMouseOut={this.handleOut}>{this.state.texto4}</p>
                <p id="5" onMouseOver={this.handleOver} onMouseOut={this.handleOut}>{this.state.texto5}</p>
            </div>
        );
    }
}
